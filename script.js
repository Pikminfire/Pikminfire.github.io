function updateRightPane(contentType) {
  ...
  switch (contentType) {
    case 'Content for PDF':
      rightPane.innerHTML = '<div id = "pdf-container"><a href="/Resume/Resume.pdf" target="_blank"><img src="/imgs/pdf.png" alt="PDF" style="height:150px; width:auto; display:block;"><span class = "text" style="text-align: center; margin-top: 5px;">Click here for Resume</span></a></div>';
      break;
